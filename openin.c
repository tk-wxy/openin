                                  ...
                                  int cli, const wchar_t *srcPath)
{
    ...
    static const wchar_t *CLI_TPL[] = {
        ...
        L"            /* cmd /c start 是批处理启动 GUI 应用的经典方式,能可靠获得前台焦点",
        L"               (后台上下文也能激活,即资源管理器同款行为) */",
        L"            cmdline[0] = L'\\0';",
        L"            wcscat_s(cmdline, 2 * MAX_PATH + 512, L\"/c start \\\"\\\" \\\"\");",
        L"            wcscat_s(cmdline, 2 * MAX_PATH + 512, wtPath);",
        L"            wcscat_s(cmdline, 2 * MAX_PATH + 512, L\"\\\" -d \\\"\");",
        L"            wcscat_s(cmdline, 2 * MAX_PATH + 512, cwd);",
        L"            wcscat_s(cmdline, 2 * MAX_PATH + 512, L\"\\\" cmd /k \\\"\");",
        ...
        L"                                NULL, NULL, FALSE, CREATE_NO_WINDOW, NULL, NULL, &si, &pi)) {",
        L"                CloseHandle(pi.hThread);",
        L"                CloseHandle(pi.hProcess);",
        L"                return 0;",
        L"            }",
